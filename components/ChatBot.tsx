...
const WELCOME = 'Hi! Describe your campaign and I will help generate content.'
const SYSTEM_PROMPT = `You are ForgeBot, the AI assistant for CampaignForge — a platform that generates blogs, podcasts, videos, LinkedIn posts, emails and more from one brief. Help users create campaign briefs, understand the platform, and maximize their content output. Keep responses concise and action-oriented.`
...
export default function ChatBot() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        aria-label={open ? 'Close chat' : 'Open ForgeBot'}
        style={{
      ...
      {open && (
        <div style={{
          ...
          animation: 'forge-slide-up 0.22s ease-out',
        }}>
          <style>{`
            ...
            .forge-msg::-webkit-scrollbar { width: 4px; }
            .forge-msg::-webkit-scrollbar-track { background: transparent; }
            .forge-msg::-webkit-scrollbar-thumb { background: rgba(124,58,237,0.3); border-radius: 2px; }
            @keyframes forge-bounce { 0%,80%,100%{transform:translateY(0)} 40%{transform:translateY(-6px)} }
          `}</style>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ color: '#fed7aa', fontSize: 11, display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{ display: 'flex', justifyContent: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                <div style={{
                  ...
                  background: m.role === 'user' ? 'linear-gradient(135deg, #f97316, #ea580c)' : 'rgba(124,58,237,0.1)',
                ...
                <div style={{
                  ...
                  {[0, 1, 2].map(d => (
                    <span key={d} style={{
                      ...
                      animation: `forge-bounce 1.2s ${d * 0.2}s infinite ease-in-out`,
                    }}/>
                  ))}
                </div>
              </div>
